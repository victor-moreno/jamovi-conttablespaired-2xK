...
# its bundled R version and conttablespaired2xK needs a matching release.
#
#   bash tools/release.sh 4.6.0
#
# Requires conttablespaired2xK/conttablespaired2xK_1.0.0.jmo to already exist (build it first
