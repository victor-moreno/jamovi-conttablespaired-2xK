# conttablespaired2xK — design notes

Full technical detail behind the module: reference conventions, confidence-interval formulas, the
RxR generalization proofs, bundled datasets, dependencies, references, naming, and translations.
See [README.md](README.md) for the short version.
